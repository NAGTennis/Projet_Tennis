...
Très bon serveur ou pas -> influence dans les TieBreak
Endurant ou pas (exemple s il a tendance a gagné ces matchs en 5 set ou 3 pour les filles)
Nombre de jeu par match, en cas de Tie break rajouter un jeu suppl?mentaire 
