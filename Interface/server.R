...
shinyServer(function(input, output, session) {
  ...
  info_joueurs <- eventReactive(input$go|input$predict, {
    p1_name=input$nom1
    p1_id=ifelse(length(Tennis_table_work[w_name==p1_name]$w_id)>0,Tennis_table_work[w_name==p1_name]$w_id[1],Tennis_table_work[l_name==p1_name]$l_id[1])
    p2_name=input$nom2
    p2_id=ifelse(length(Tennis_table_work[w_name==p2_name]$w_id)>0,Tennis_table_work[w_name==p2_name]$w_id[1],Tennis_table_work[l_name==p2_name]$l_id[1])
    ...
    hand1=ifelse(atp_players[Player_Id==p1_id]$Main_Forte=='R',1,0)
    hand2=ifelse(atp_players[Player_Id==p2_id]$Main_Forte=='R',1,0)
  ...
  output$stats_joueurs <- renderAmCharts({
    p1_name=input$nom1
    p1_id=ifelse(length(Tennis_table_work[w_name==p1_name]$w_id)>0,Tennis_table_work[w_name==p1_name]$w_id[1],Tennis_table_work[l_name==p1_name]$l_id[1])
    p2_name=input$nom2
    p2_id=ifelse(length(Tennis_table_work[w_name==p2_name]$w_id)>0,Tennis_table_work[w_name==p2_name]$w_id[1],Tennis_table_work[l_name==p2_name]$l_id[1])
    ...
    tab=data.frame(
      c("Dix_ace","Dix_df","Dix_1stIn","Dix_1stWon","Dix_2ndWon","Dix_bpSaved","Dix_bpMean","Dix_bpConverted","Dix_svptWon","Dix_returnPtWon","Dix_1stReturnWon","Dix_2ndReturnWon")
